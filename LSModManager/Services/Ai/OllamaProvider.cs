...
/// (ohne <c>format=json</c> — wir wollen freien Text zurück), <c>/api/tags</c>
/// für die lokal installierten Modelle und <c>/api/pull</c> (NDJSON-Streaming)
/// zum Herunterladen neuer Modelle direkt aus der App.
/// </summary>
public sealed class OllamaProvider : IAiProvider
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var req = new ChatRequest(Model: _model, Messages: messages, Stream: false);
