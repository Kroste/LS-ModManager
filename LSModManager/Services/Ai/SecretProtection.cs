...
/// versehentlich veröffentlichter Config-Dump die Keys direkt preisgibt.
/// libsecret-Support kann später nachgerüstet werden.
/// </summary>
public static class SecretProtection
{
    private static readonly Logger Log = LogManager.GetCurrentClassLogger();
    // Projekt-spezifisch — verhindert, dass andere Kroste-Apps auf demselben
    // Rechner die Keys entschlüsseln könnten (siehe DeriveKey unten).
    private static readonly byte[] Salt = "lsmodmanager-secret-v1"u8.ToArray();
    ...
    {
        string material = $"{Environment.MachineName}|{Environment.UserName}|lsmodmanager";
